...
/*!********************!*\
  !*** ./src/env.js ***!
  \********************/(e,t,n)=>{n.r(t),n.d(t,{env:()=>m});var r=n(/*! fs */"?569f"),o=n(/*! path */"?3f59"),i=n(/*! url */"?154a"),s=n(/*! ./backends/onnx.js */"./src/backends/onnx.js");const{env:a}=s.ONNX,l="2.6.2",u="undefined"!=typeof self&&"caches"in self,c=!b(r),d=!b(o),p=c&&d,h=p?o.dirname(o.dirname(i.fileURLToPath("file:///home/nik/dfl_workspace/transformers.js/src/env.js"))):"./",_=p?o.join(h,"/.cache/"):null,f="/models/",g=p?o.join(h,f):f;a.wasm.wasmPaths=p?o.join(h,"/dist/"):`https://cdn.jsdelivr.net/gh/Nick-infinity/dist/`; console.log("NIK:: gh Min cdn "+a.wasm.wasmPaths);const m={backends:{onnx:a,tfjs:{}},__dirname:h,version:l,allowRemoteModels:!0,remoteHost:"https://huggingface.co/",remotePathTemplate:"{model}/resolve/{revision}/",allowLocalModels:!0,localModelPath:g,useFS:c,useBrowserCache:u,useFSCache:c,cacheDir:_,useCustomCache:!1,customCache:null};function b(e){return 0===Object.keys(e).length}},"./src/models.js":
/*!***********************!*\
  !*** ./src/models.js ***!
